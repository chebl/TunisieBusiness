 ...
 */
class SousCategorie extends \Business\AnnuaireBundle\Entity\SousCategorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\SousCategorie' . "\0" . 'id', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\SousCategorie' . "\0" . 'nom', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\SousCategorie' . "\0" . 'datepublication', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\SousCategorie' . "\0" . 'categorie', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\SousCategorie' . "\0" . 'annonces');
        }
