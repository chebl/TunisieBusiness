 ...
 */
class User extends \Business\AnnuaireBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'typecompte', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'telephone', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'nomsociete', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'description', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'codepostal', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'path', 'file', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'dateinscription', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'specialite', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'annonces', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'promotions', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'reponsespromotions', '' . "\0" . 'Business\\AnnuaireBundle\\Entity\\User' . "\0" . 'reponsesanonces', 'createdAt', 'updatedAt', 'twoStepVerificationCode', 'dateOfBirth', 'firstname', 'lastname', 'website', 'biography', 'gender', 'locale', 'timezone', 'phone', 'facebookUid', 'facebookName', 'facebookData', 'twitterUid', 'twitterName', 'twitterData', 'gplusUid', 'gplusName', 'gplusData', 'token', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addReponsespromotion(\Business\AnnuaireBundle\Entity\RepPromotion $reponsespromotions)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReponsespromotion', array($reponsespromotions));

        return parent::addReponsespromotion($reponsespromotions);
    }
    ...
    public function removeReponsespromotion(\Business\AnnuaireBundle\Entity\RepPromotion $reponsespromotions)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReponsespromotion', array($reponsespromotions));

        return parent::removeReponsespromotion($reponsespromotions);
    }
    ...
    public function getReponsespromotions()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReponsespromotions', array());

        return parent::getReponsespromotions();
    }
    ...
    public function addReponsesanonce(\Business\AnnuaireBundle\Entity\RepAnnonce $reponsesanonces)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReponsesanonce', array($reponsesanonces));

        return parent::addReponsesanonce($reponsesanonces);
    }
    ...
    public function removeReponsesanonce(\Business\AnnuaireBundle\Entity\RepAnnonce $reponsesanonces)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReponsesanonce', array($reponsesanonces));

        return parent::removeReponsesanonce($reponsesanonces);
    }
    ...
    public function getReponsesanonces()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReponsesanonces', array());

        return parent::getReponsesanonces();
    }
